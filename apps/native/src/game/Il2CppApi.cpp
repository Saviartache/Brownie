...
Result<Il2CppApi> Il2CppApi::Load(HMODULE game_assembly) {
    ...
    BROWNIE_BIND(il2cpp_field_static_set_value)
    BROWNIE_BIND(il2cpp_class_value_size)
    BROWNIE_BIND(il2cpp_class_instance_size)
    ...
    BROWNIE_BIND(il2cpp_class_from_type)
